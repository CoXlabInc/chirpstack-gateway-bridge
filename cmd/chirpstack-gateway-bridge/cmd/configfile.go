...
type="{{ .Backend.Type }}"
  ...
  #
  # The duration in unit of seconds after which the gateway is cleaned up from the registry after no activity. When gateways are not seen for this time, they will be removed from registry, and their state will be changed to OFFLINE.
